...
- (void)setAnimationType:(GLAnimationType)animationType WithSubType:(NSInteger)subtype
{
    ...
    switch (animationType) {
        case GLAnimationTypeFade:
            [self transitionWithType:kCATransitionFade WithSubtype:subtypeString];
            break;
            
        case GLAnimationTypePush:
            [self transitionWithType:kCATransitionPush WithSubtype:subtypeString];
            break;
            
        case GLAnimationTypeReveal:
            [self transitionWithType:kCATransitionReveal WithSubtype:subtypeString];
            break;
            
        case GLAnimationTypeMoveIn:
            [self transitionWithType:kCATransitionMoveIn WithSubtype:subtypeString];
            break;
            
        case GLAnimationTypeCube:
            [self transitionWithType:@"cube" WithSubtype:subtypeString];
            break;
            
        case GLAnimationTypeSuckEffect:
            [self transitionWithType:@"suckEffect" WithSubtype:subtypeString];
            break;
            
        case GLAnimationTypeOglFlip:
            [self transitionWithType:@"oglFlip" WithSubtype:subtypeString];
            break;
            
        case GLAnimationTypeRippleEffect:
            [self transitionWithType:@"rippleEffect" WithSubtype:subtypeString];
            break;
            
        case GLAnimationTypePageCurl:
            [self transitionWithType:@"pageCurl" WithSubtype:subtypeString];
            break;
            
        case GLAnimationTypePageUnCurl:
            [self transitionWithType:@"pageUnCurl" WithSubtype:subtypeString];
            break;
            
        case GLAnimationTypeCameraIrisHollowOpen:
            [self transitionWithType:@"cameraIrisHollowOpen" WithSubtype:subtypeString];
            break;
            
        case GLAnimationTypeCameraIrisHollowClose:
            [self transitionWithType:@"cameraIrisHollowClose" WithSubtype:subtypeString];
            break;
            
        case GLAnimationTypeCurlDown:
            [self animationWithViewWithAnimationTransition:UIViewAnimationTransitionCurlDown];
            break;
            
        case GLAnimationTypeCurlUp:
            [self animationWithViewWithAnimationTransition:UIViewAnimationTransitionCurlUp];
            break;
            
        case GLAnimationTypeFlipFromLeft:
            [self animationWithViewWithAnimationTransition:UIViewAnimationTransitionFlipFromLeft];
            break;
            
        case GLAnimationTypeFlipFromRight:
            [self animationWithViewWithAnimationTransition:UIViewAnimationTransitionFlipFromRight];
            break;
        case GLAnimationTypeFlipFromThumb:
            [self thumbAnimation];
            break;
        default:
            break;
...
#pragma UIView实现动画
- (void) animationWithViewWithAnimationTransition : (UIViewAnimationTransition) transition
{
